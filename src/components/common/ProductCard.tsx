...
import { ShoppingBag, Eye, MessageCircle, Plus, Minus, Flame, Sparkles } from 'lucide-react';
      ...
      <div className="p-3.5 sm:p-4 flex flex-col flex-1 justify-between">
        ...
        <div className="mt-3.5 pt-3 border-t border-slate-800/80 space-y-2">
          ...
          <div className="flex items-center gap-2">
            {!isOutOfStock && (
              <div className="flex items-center border border-slate-700 bg-slate-950 rounded-xl overflow-hidden p-0.5 shrink-0">
                <button
                  type="button"
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-1.5 py-2 px-3 rounded-xl text-xs sm:text-sm font-bold transition-all shadow-md ${
                isOutOfStock
                  ? 'bg-slate-800 text-slate-500 cursor-not-allowed border border-slate-700'
                  : 'bg-amber-500 hover:bg-amber-400 text-slate-950 hover:shadow-amber-500/20 active:scale-98'
              }`}
            >
          ...
          <div className="flex items-center gap-1.5 text-xs">
            <Link
              ...
              className="flex-1 flex items-center justify-center gap-1 py-1.5 px-2 rounded-lg bg-slate-800/80 hover:bg-slate-800 text-slate-300 hover:text-white transition-colors border border-slate-700/50"
            >
            ...
            <button
              ...
              className="flex-1 flex items-center justify-center gap-1 py-1.5 px-2 rounded-lg bg-emerald-950/80 hover:bg-emerald-900 text-emerald-400 hover:text-emerald-300 transition-colors border border-emerald-700/40"
